...
@testset "Shorthand" begin
    ...
    @test VegaLite.parse_shortcut("foo:Q") == ["field" => "foo", "type" => "quantitative"]
    @test VegaLite.parse_shortcut("foo:quantitative") ==
    ...
    @test VegaLite.parse_shortcut("foo:T") == ["field" => "foo", "type" => "temporal"]
    @test VegaLite.parse_shortcut("foo:temporal") ==
          ["field" => "foo", "type" => "temporal"]
    @test VegaLite.parse_shortcut("foo:tEmporAl") ==
          ["field" => "foo", "type" => "temporal"]
    ...
    @test VegaLite.parse_shortcut("sum(foo)") ==
          ["aggregate" => "sum", "field" => "foo", "type" => "quantitative"]
    @test VegaLite.parse_shortcut("sum(foo):o") ==
          ["aggregate" => "sum", "field" => "foo", "type" => "ordinal"]
    @test VegaLite.parse_shortcut("sum(foo):quantitative") ==
          ["aggregate" => "sum", "field" => "foo", "type" => "quantitative"]
    @test_throws ArgumentError VegaLite.parse_shortcut("sum(foo):bar")

    @test VegaLite.parse_shortcut("year(foo)") ==
          ["timeUnit" => "year", "field" => "foo", "type" => "temporal"]
    @test VegaLite.parse_shortcut("month(foo):o") ==
          ["timeUnit" => "month", "field" => "foo", "type" => "ordinal"]
    @test VegaLite.parse_shortcut("yearmonth(foo):quantitative") ==
          ["timeUnit" => "yearmonth", "field" => "foo", "type" => "quantitative"]

    @test VegaLite.parse_shortcut("count()") ==
          ["aggregate" => "count", "type" => "quantitative"]
    @test VegaLite.parse_shortcut("count():o") ==
          ["aggregate" => "count", "type" => "ordinal"]
