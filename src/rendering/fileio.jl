...
function fileio_save(
    file::FileIO.File{FileIO.format"vegalite"},
    data::VLSpec;
    include_data=true,
    kwargs...,
)
...
function fileio_save(
    stream::FileIO.Stream{FileIO.format"vegalite"},
    data::VLSpec;
    include_data=true,
    kwargs...,
)
...
function fileio_save(
    file::FileIO.File{FileIO.format"vega"},
    data::VLSpec;
    include_data=true,
    kwargs...,
)
...
function fileio_save(
    stream::FileIO.Stream{FileIO.format"vega"},
    data::VLSpec;
    include_data=true,
    kwargs...,
)
